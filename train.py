...
if __name__ == '__main__':
    ...
    """ Data processing """
    parser.add_argument('--select_data', type=str, default='Traffic_Sign-Signboard-crop-dgt_num-mbc',
                        help='select training data (default is MJ-ST, which means MJ and ST used as training data)')
    parser.add_argument('--batch_ratio', type=str, default='0.3-0.3-0.2-0.1-0.1',
